...
class RequestForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['from_user'].queryset = MyUser.objects.filter(is_active=True).exclude(username=MyUser.ANON)
        self.fields['to_user'].queryset = MyUser.objects.filter(is_active=True).exclude(username=MyUser.ANON)
